    ...
    <header className="border-b border-[#141414]/5 bg-white/40 backdrop-blur-md sticky top-0 z-10">
      <div className="max-w-full mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-xl font-header font-medium tracking-tight leading-none text-[#141414]">
              {APP_NAME}
            </h1>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-[10px] font-medium text-[#141414]/40 uppercase tracking-wider">
                v{APP_VERSION}
              </span>
              {isSyncing && (
